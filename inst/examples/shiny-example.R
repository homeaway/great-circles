...
server = function(input, output) {
  output$arcs <- rendergreatCircles(greatCircles(
    data.frame(longitude.start=c(-0.1015987,9.9278215,2.3470599,12.5359979,-42.9232368,114.1537584,
  ...
  output$hithere = renderText({"All Over the World"})
}
